      ...
      <div className="max-w-6xl mx-auto py-10 px-3">
        <div className="flex flex-col text-center items-center justify-center gap-5">
          ...
          <div className="w-full ">
            <input type="text" className="rounded-2xl w-full px-3 py-3 border-primary-600 border outline-none text-xl italic text-center focus:ring-1 ring-primary-600 font-semibold" placeholder="ค้นหาองค์กรต้นแบบคุณธรรม" />
          </div>
